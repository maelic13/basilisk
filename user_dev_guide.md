...
- [ ] **6.5 SEE pruning of quiets + capture futility pruning, lmrDepth-based** (SF + Ethereal both). High pruning-interaction risk — implement separately, SPRT the coherent pair. — Fable 5 high (alt: Opus 4.8 high)
