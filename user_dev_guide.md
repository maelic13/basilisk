...
- [ ] **6.4 Post-LMR deeper re-search + post-re-search conthist update** (SF + Weiss both) + rider: Weiss-style cap on stacked double-extensions. — Sonnet 5 medium
...
- [ ] **6.9 wave2 joint SPSA** — the conserved compute, LAST: ~20–25 knobs (all new ones + LMP/NMP/ProbCut/qsearch margins/hist-prune/IIR/corr weights/razor depth/`lmr_cut_node_adj`). ~5000 iters @ 3+0.03, then **SPRT the converged result** (the 5.9 lesson). — Sonnet 5 medium
