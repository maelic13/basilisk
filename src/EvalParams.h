...
struct EvalParams {
    ...
    int mg_val[7] = {0, 82, 337, 365, 477, 1025, 0};
    int eg_val[7] = {0, 94, 281, 297, 512,  936, 0};
    ...
    int passed_eg[8] = {  0, 10, 17,  35,  62, 100, 170,   0 };

    // Supported passer (passed pawn defended by a friendly pawn)
    int pass_supp_mg      =  8;
    int pass_supp_eg_base =  6;
    int pass_supp_eg_rank =  4;  // multiplied by relative rank
    ...
    int pass_free_eg =  6;  // stop square empty
    ...
    int mob_mg[7] = {0, 0, 4, 5, 2, 1, 0};
    int mob_eg[7] = {0, 0, 4, 5, 4, 2, 0};
    ...
    int hang_pen[7] = {0, 0, 45, 45, 60, 80, 0};

    // ---- Passed pawn king proximity (endgame) ------------------------------
    int prox_base = 2;  // constant in (prox_base + rel_r) distance multiplier
