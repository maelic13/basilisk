...
std::string Parameters::uciOptions() {
    ...
    opts +=
        ...
        "option name HistPruneCoeff type spin default 14004 min 1000 max 28000\n"
        "option name SeePruneCoeff type spin default 73 min 30 max 160\n"
        "option name CapFutDepth type spin default 1 min 0 max 10\n"
        "option name CapFutBase type spin default 198 min 0 max 500\n"
        "option name CapFutCoeff type spin default 283 min 0 max 500\n"
        ...
        "option name LmrHistDiv type spin default 5683 min 4096 max 16384\n"
        "option name LmrNonPvAdj type spin default 1024 min 0 max 3072\n"
        "option name LmrCutNodeAdj type spin default 401 min 0 max 3072\n"
        "option name LmrTtPvAdj type spin default 23 min 0 max 3072\n"
        "option name LmrNotImprovingAdj type spin default 89 min 0 max 3072\n"
        "option name LmrTtCapture type spin default 301 min 0 max 3072\n"
        "option name PostLmrHistScale type spin default 104 min 0 max 300\n"
        "option name HistBonusQuad type spin default 62 min 0 max 128\n"
        "option name HistBonusLin type spin default 120 min 0 max 400\n"
        "option name HistBonusMax type spin default 1863 min 512 max 4096\n"
        "option name HistMalusQuad type spin default 62 min 0 max 128\n"
        "option name HistMalusLin type spin default 143 min 0 max 400\n"
        "option name HistMalusMax type spin default 1304 min 512 max 4096\n"
        "option name HistTtMoveBonus type spin default 29 min 0 max 1024\n"
