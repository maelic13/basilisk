...
| BAS-X15 | Rarog `4aea0c7`/RAR-E10 replaced its coarse KBNK corner metric with a bishop-colour-selected weak-king diagonal potential. At 60k nodes KBN-K conversion moved **19.4% -> 96.9%**, KBB-K 78.0% -> 100%, and 61 rule-50 failures fell to zero. A near-1:1 diagonal/king balance was ineffective; strong corner-pull dominance was essential. | Port the geometry, not Rarog's constants or broad activation. Basilisk already has an exact KBNK dispatcher and all required inputs. The solution does not require a bishop-position term and does not reopen the locally refuted bishop-proximity or flight-square features. | **6.1.a–f**; `analysis/kbnk_diagonal_port_v1.md` |
